...
exec "Snippet class /**<CR> *classname:".st."ClassName".et."<CR>*scope:".st."PUBLIC".et."<CR>*<CR>**/<CR><CR>class ".st."ClassName".et." ".st."extendsAnotherClass".et."<CR>{<CR>// internal variables<CR><CR>// Constructor<CR>function __construct ( ".st."argument".et.")<CR>{<CR>".st.et."<CR>}<CR><CR><CR>}<CR>".st.et
